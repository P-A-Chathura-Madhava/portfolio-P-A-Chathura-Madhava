    ...
    <div className="h-full bg-primary/60">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="container flex flex-col justify-center h-full mx-auto text-center xl:pt-40 xl:text-left">
          ...
          >
            ...
            magni placeat accusamus itaque saepe sit tenetur totam et! Laborum
            tempora rem assumenda eveniet ipsam, harum suscipit numquam quis
            beatae voluptates.
          </motion.p>
          {/* btn */}
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <motion.div
          ...
          className="w-full h-full max-w-[1038px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[8%]"
        >
          <Avatar />
        </motion.div>
      </div>
